...
public class FilesViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "选择要发送的文件", Toast.LENGTH_SHORT)
                .show();
        ...
        adapter = new SimpleAdapter(getApplicationContext(), listItem,
                R.layout.item_view, new String[]{"image", "name", "path",
                "type", "parent", "select"}, new int[]{R.id.image,
                R.id.file_name, R.id.file_path, R.id.file_type,
                R.id.file_parent, R.id.select});
        ...
        fileView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (Boolean.parseBoolean(isDirectory.getText().toString())) {
                    // 进入目录
                    FilesViewActivity.this.FilesListView(path.getText()
                            .toString());
